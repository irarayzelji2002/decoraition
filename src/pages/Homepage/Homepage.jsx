          ...
          <div className="recent-designs">
            <div className="separator">
              ...
              <TooltipWithClickAway
                ...
                tooltipClickLocked={tooltipClickLocked}
                setTooltipClickLocked={setTooltipClickLocked}
                title={
                ...
                onMouseEnter={() => {
                  setOpenDesignTooltip(true);
                  setOpenProjectTooltip(false);
                }}
              >
                <IconButton
                  sx={{
          ...
          <div className="recent-designs">
            <div className="separator">
              ...
              <TooltipWithClickAway
                ...
                setTooltipClickLocked={setTooltipClickLocked}
                title={
                  <DescriptionTooltip description="Projects are a collection of designs, press the create a project then import your works or create one inside" />
                }
                onMouseEnter={() => {
                  setOpenProjectTooltip(true);
                  setOpenDesignTooltip(false);
                }}
              >
                <IconButton
                  sx={{
